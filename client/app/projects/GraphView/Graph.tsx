          ...
          >
            ...
            {isTaskOptionsOpen && (
              <div className="absolute top-5 right-0 bg-white shadow-md rounded-md p-2 w-32 z-40">
                <div
                  className="text-sm font-normal text-red-500 hover:bg-orange-50 hover:text-orange-600 rounded-md p-1 w-full"
                  onClick={handleDelete}
                >
                  Delete
                </div>
                <div className="text-sm font-normal text-gray-600 hover:text-orange-600 hover:bg-orange-50 rounded-md p-1 w-full">
                  Edit
                </div>
              </div>
            )}
