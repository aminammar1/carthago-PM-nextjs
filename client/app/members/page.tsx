                  ...
                  <div className="p-6">
                    <div className="grid gap-4">
                      {team.members ? (
                        team.members.map((teamMember) => {
                          return (
                            <div
                              ...
                              className="flex items-center space-x-4 p-4 rounded-xl bg-gray-50 hover:bg-orange-50 transition-colors duration-200"
                            >
                        ...
                        <div className="text-center w-full text-secondary-950 font-normal">
